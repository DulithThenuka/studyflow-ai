        ...
        <main class="dashboard-main modern-dashboard-main">
            <div class="dashboard-hero page-hero form-hero">
                <div class="dashboard-hero-copy">
                    ...
                    <h1>Edit task</h1>
                    <p>Update the task details and keep your planner accurate and useful.</p>
                </div>
            ...
            <div class="modern-form-shell">
                <div class="modern-form-card">
                    ...
                    <form action="<?php echo URLROOT; ?>/tasks/edit/<?php echo $data['id']; ?>" method="POST" class="modern-form-v2">
                ...
                <div class="modern-side-info-card">
                    ...
                    <h3>Keep your task data clean</h3>
                    <ul class="side-tip-list">
                        <li>Move tasks to completed only when they are actually done.</li>
                        <li>Update the deadline if the schedule changes.</li>
                        <li>Adjust priority when a task becomes more urgent.</li>
                        <li>Better task data gives better planner results.</li>
                    </ul>
                </div>
            </div>
        </main>
