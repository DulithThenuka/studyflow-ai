        ...
        <main class="dashboard-main modern-dashboard-main">
            <div class="dashboard-hero page-hero form-hero">
                <div class="dashboard-hero-copy">
                    ...
                    <p>Create a study task with subject, deadline, priority, and effort details.</p>
                </div>
            ...
            <div class="modern-form-shell">
                <div class="modern-form-card">
                    <div class="panel-top">
                        <div>
                            ...
                            <h3>Task details</h3>
                            <p>Fill in the details below to save a new task.</p>
                        </div>
                    </div>

                    <form action="<?php echo URLROOT; ?>/tasks/add" method="POST" class="modern-form-v2">
                        <div class="form-grid two-col-grid">
                            ...
                            <div class="form-group modern-field">
                                ...
                                <input type="text" name="title" id="title" value="<?php echo htmlspecialchars($data['title']); ?>" placeholder="e.g. Database Assignment">
                        ...
                        <div class="form-group modern-field">
                            ...
                            <textarea name="description" id="description" rows="5" placeholder="Add task details"><?php echo htmlspecialchars($data['description']); ?></textarea>
                        </div>
                        ...
                        <div class="form-grid three-col-grid">
                            ...
                            <div class="form-group modern-field">
                                ...
                                <input type="date" name="deadline" id="deadline" value="<?php echo htmlspecialchars($data['deadline']); ?>">
                            </div>

                            <div class="form-group modern-field">
                                <label for="estimated_hours">Estimated Hours</label>
                                <input type="number" step="0.5" min="0.5" name="estimated_hours" id="estimated_hours" value="<?php echo htmlspecialchars($data['estimated_hours']); ?>" placeholder="e.g. 2">
                ...
                <div class="modern-side-info-card">
                    ...
                    <h3>Make your task list smarter</h3>
                    <ul class="side-tip-list">
                        <li>Use clear task titles so you can scan your list faster.</li>
                        <li>Add deadlines to help the planner rank what matters.</li>
                        <li>Set realistic estimated hours for better planning.</li>
                        <li>Use status updates to keep your dashboard accurate.</li>
                    </ul>
                </div>
            </div>
        </main>
